...
## [0.1.0](https://github.com/yukineko/claude-harnesses/releases/tag/harness-status-v0.1.0) - 2026-07-02

### Added

- *(harness-status)* plugin activation-scope stratification + resolve dormancy
