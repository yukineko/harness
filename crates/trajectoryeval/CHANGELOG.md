...
## [0.1.0](https://github.com/yukineko/claude-harnesses/releases/tag/trajectoryeval-v0.1.0) - 2026-07-02

### Added

- *(trajectoryeval)* trajectory-match verifier sibling (check + transcript extract)
...
- rebuild plugin binaries [skip ci]
- *(trajectoryeval)* stage darwin-arm64 binary for local install
