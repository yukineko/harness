...
## [0.1.0](https://github.com/yukineko/claude-harnesses/releases/tag/schemaguard-v0.1.0) - 2026-07-02

### Added

- *(schemaguard)* schema-validation gate for LLM structured outputs at source→executor boundaries
