...
const CONCEPTS: &[(&str, &[&str])] = &[
    ("auth", &[
        ...
        "signup", "session", "credential", "credentials", "oauth", "token",
        "jwt", "password", "permission", "permissions", "rbac",
    ]),
    ("data", &[
        "database", "db", "sql", "query", "migration", "migrate", "schema",
        "table", "orm", "postgres", "mysql", "sqlite", "dataset",
    ]),
    ("api", &[
        "api", "endpoint", "endpoints", "route", "router", "handler", "controller",
        "rest", "graphql", "grpc", "request", "response",
    ]),
    ("ui", &[
        "ui", "frontend", "component", "render", "css", "style", "styles",
        "layout", "button", "form", "page", "view", "modal",
    ]),
    ("test", &[
        "test", "tests", "spec", "assert", "fixture", "mock", "coverage", "unit",
        "integration", "e2e",
    ]),
    ("perf", &[
        "performance", "perf", "latency", "throughput", "optimize", "optimization",
        "cache", "caching", "bench", "benchmark", "profil",
    ]),
    ("infra", &[
        "deploy", "deployment", "ci", "cd", "pipeline", "docker", "kubernetes",
        "k8s", "terraform", "release", "rollout",
    ]),
    ("doc", &[
    ...
    ("parse", &[
        "parse", "parser", "lexer", "tokenize", "tokenizer", "grammar", "ast",
...
pub fn stem(word: &str) -> String {
    const SUF: &[&str] = &[
        "izations", "isations", "ization", "isation", "ations", "ation", "izing",
        "ising", "ings", "ing", "tion", "ies", "ed", "es", "s",
    ];
    for s in SUF {
