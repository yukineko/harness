...
## [0.1.0](https://github.com/yukineko/claude-harnesses/releases/tag/tracekit-v0.1.0) - 2026-07-02

### Added

- *(tracekit)* add span-tree tracer for condukt runs + OTel GenAI export
...
- rebuild plugin binaries [skip ci]
- *(core)* hoist shared Span model + JSONL loader into harness-core::spans
